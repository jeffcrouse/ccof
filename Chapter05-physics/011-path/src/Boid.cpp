...
void Boid::draw() {
    ...
    if (debug) {
        ofFill();
        ofSetColor(0x000000);
        ofDrawLine(loc.x,loc.y,predictLoc.x, predictLoc.y);
        ofDrawEllipse(predictLoc.x, predictLoc.y,4,4);
    }
    ...
    if (debug) {
        ...
        ofSetColor(0x000000);
        ofDrawLine(predictLoc.x, predictLoc.y, target.x, target.y);
        ofDrawEllipse(target.x,target.y,4,4);
        ...
        ofDrawEllipse(target.x+dir.x, target.y+dir.y, 8, 8);
    }
}
